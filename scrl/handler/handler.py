    ...
    def handle_single_query(self, query_content: dict, api_result_dict: dict):
        try:
            ...
            if fuc_name == "web_search":
                ...
                # print('-----search_query_list',search_query_list)
                ...
                # print('-----web_page_info_list_batch',web_page_info_list_batch)
                ...
                # print('-----cur_action_info',cur_action_info)
                ...
                sub_query = arguments.get("query", question)
                ...
                if len(self.id_to_context[idx]) >= 1:
                    ...
                    print('-----2',read_webpage_list[0])
                else:
                    read_webpage_list: List[WebPageInfo] = self.reading_agent.read_batch(user_query=question, search_result_info_list=SearchResultInfo(
                    search_query=url_list,
                    web_page_info_list=web_page_info_list
                ), url_list=url_list, web_search_agent=self.web_search_agent)
                content = []
